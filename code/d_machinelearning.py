...
def data():
    ...
    abnormal_data = np.vstack((r_data,a_data))


    normal_data = d_data

    abnormal_label = r_label
    abnormal_label = np.vstack((r_label,a_label))


    normal_label = d_label
